			...
			<div id="main-content">
				...
				%>
					...
					while (rs2.next()) {
						...
						out.print("<tr>");
						out.print("<td>" + rs2.getString("vote_point") + "</td>");
						out.print("<td>" + starString + "(" + rs2.getDouble("star_avg") + ")" + "</td>");
						out.print("<td onclick='javascript:goPage("+rs2.getInt("review_id")+");'>" + rs2.getString("subject") + "</td>");
						out.print("<td>" + rs2.getString("vote_cnt") + "</td>");
