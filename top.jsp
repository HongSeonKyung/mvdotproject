...
<script type="text/javascript">
	...
	function openFacebookShare() {
		...
		window.open(src, "", "width=300, height=300,top=200px,left=400");
	}
	function openSearchWindow(){ 
		 window.open("searchmovie.html","","scrollbars=yes,toolbar=yes,resizable=yes,width=200,height=400,left=300,top=100"); 
  }   
